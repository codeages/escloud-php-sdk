...
class WeChatService extends BaseService
{
     ...
     *               template_id  创建的模版id
     */
    public function createNotificationTemplate($templateCode, $templateParams = array())
    {
     ...
     *               success bool 是否删除成功
     */
    public function deleteNotificationTemplate($templateId, $templateParams = array())
    {
